...
Data models are written in TypeSpec against the `@phaselock/typespec`
...
```
engine/       @phaselock/typespec — the definition library apps import.
...
emitter-ts/   @phaselock/typespec-ts — TypeScript emitter.
emitter-py/   @phaselock/typespec-py — Python emitter.
emitter-go/   @phaselock/typespec-go — Go emitter.
